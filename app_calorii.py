...
# Funcția pentru calcularea valorii calorice pentru un aliment
...
while True:
    aliment = input("Introduceti un aliment consumat sau tastati 'gata' pentru a opri: ")
    if aliment == "gata":
        break
    if aliment not in alimente:
        print("Alimentul introdus nu exista in baza de date.")
        continue
    total_calorii += alimente[aliment]
    alimente_consumate.append(aliment)

print("Nr total de calorii consumate este: ", total_calorii)

print("Alimentele consumate sunt: ", alimente_consumate)
'''
